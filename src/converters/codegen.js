...
export function jsonToZod(input, options = {}) {
  ...
  return result(lines.join('\n') + '\n', {
    notes: [INFERENCE_NOTE, 'Generated schema text is never executed by FormatPort.'],
  });
}
...
export const SQL_LIMITATIONS = [
  ...
  'Generated SQL is text. FormatPort never connects to a database and never executes it.',
];
...
export function jsonToSql(input, options = {}) {
  ...
  const header = [
    '-- Generated by FormatPort from a JSON sample. Review before running.',
